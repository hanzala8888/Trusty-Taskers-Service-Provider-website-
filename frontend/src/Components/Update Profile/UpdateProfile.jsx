...
//         try {
//             const updatedData = { ...updatedProfile, image: imageUrl };

//             let update = await fetch('http://localhost:4500/updateProfile', {
//                 method: "PUT",
//                 headers: {
//                     "Content-Type": "application/json"
//                 },
//                 body: JSON.stringify({ userId, category: updatedProfile.category, ...updatedData })
//             });
